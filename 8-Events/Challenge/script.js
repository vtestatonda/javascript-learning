...
const getRandomProfile = (profileList) => {
  ...
  //math.random nos devuelve un numero aleatorio entre el 0 y el 1. Necesitamos un numero correspondiente a la longitud del indice (0,99), por eso el * y la longitud del indice.
  //math.ceil devuelve un numero entero
...
/* Utilizando eventos, agregar algun efecto de hover a la imagen (puede ser algun cambio en la forma, un blur, 
...
const changeImageRadius = () => {
  ...
  ////toggle quita una clase si existe o agrega una clase si no existe.
};
