...
/* WHILE */
//variable se declara afuera
// let i = 0;
// while (i <= 10) {
//   console.log(i);
//   i++;
// }
// //acordarse de colocar la actualizacion de actualizacion que sume da a 1

/* DO WHILE*/
// // la diferencia con while es que la primera iteracion la hace si o si
// // La variable se declara afuera
// let i = 0;
// do {
//   console.log(i);
//   //acordarse de colocar la actualizacion de actualizacion que sume da a 1
...
/* EJERCICIOS */
/* 1) Triangulo de #. Para este ejercicio, construir un programa que una vez concluido nos permita ver en consola un triangulo formado con #, de la siguiente manera:
#
##
###
####
...
/*2) Numeros pares e impares. Hacer un programa que itere por los numeros del 0 al 10 y, por cada uno de ellos, imprima el numero y nos diga si es par o impar. 
Ejemplo:
0 es par
1 es impar
2 es par
