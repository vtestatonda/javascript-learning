...
////Por mas que el tiempo sea 0 (instantaneo), se publica al final del proceso sincronico
// console.log("Me despierto");
// console.log("Me lavo la cara");
// console.log("Pongo la cafetera");
// setTimeout(() => {
...
/* PROMESAS*/
//// 3 estados: Pendiente, resuelta, rechazada, Otro ejemplo
...
/* Async-Await - alternativa para manejar asincronismo */
// const pagarConTarjeta = (precio, isConected) =>
//   new Promise((resolve, reject) => {
//     const limite = 10000;
//     console.log("Procesando el pago");
...
/* Promise.all* - trabaja con un arreglo (varias consultas) y devuelve todas las respuestas/
// const pagarConTarjeta = (precio, isConected) =>
//   new Promise((resolve, reject) => {
//     const limite = 10000;
//     console.log("Procesando el pago");
...
////el await espera a que la promesa se resuelva para continuar entonces se resuelve Mario luego de 10 segundos y luego sigue por juan
//     setTimeout(() => {
//       console.log("Mario");
//       resolve();
//     }, 10);
...
// fetchSomething();
// console.log("Pedro");
////pedro esta primero porque es parte del codigo sincronico
...
// promise.then(() => console.log("Juan"));
////el settimeout y el promise se resuleven al mismo tiempo, en ese caso particular la promesa tiene prioridad
// console.log("Pedro");
...
/*GET - FETCH - Solicitar datos o informacion al servidor */
